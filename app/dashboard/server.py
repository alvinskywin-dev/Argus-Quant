...
<body>
<nav class="nav"><div class="container nav-in"><a class="brand" href="/"><img class="brand-mark" src="/static/brand/argus-quant-mark.png" alt="Argus Quant"/><div class="brand-word">ARGUS <b>QUANT</b></div></a><div class="nav-links"><a href="/signals">Signals</a><a href="/market-radar">Market Radar</a><a href="/performance-center">Performance</a><a href="/setup-library">Setup Library</a><a href="/faq">FAQ</a></div>__TG_BTN__<div class="lang-sel"><button class="lang-btn" id="lang-btn" onclick="toggleLangMenu(event)" aria-label="Select language">🌐 <span id="lang-cur">EN</span> ▾</button><div class="lang-menu" id="lang-menu"></div></div></div></nav>
