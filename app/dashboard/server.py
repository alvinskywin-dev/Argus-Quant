...
document.addEventListener('DOMContentLoaded',()=>{loadStats();setInterval(loadStats,6000);loadStrategy();loadFundingMode();setInterval(loadFundingMode,60000)})
</script>
</body>
</html>
"""
